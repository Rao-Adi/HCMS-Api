...
{
    public class DapperDataService : IDapperDataService, IDisposable
    {
        ...
        public async Task<T> QueryMultipleAsync<T>(string sql, object? parameters, Func<SqlMapper.GridReader, Task<T>> map)
        {
            EnsureConnectionOpen();

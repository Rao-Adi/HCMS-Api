...
namespace HCMS_Api.Components.HCMS.Common.DataAccess
{
    public class DataProcess
    {
        ...
        public DataProcess(IConfiguration configuration)
        {
            _configuration = configuration;
            _connectionString = _configuration.GetConnectionString("ConnectionString");
        }
        private DataTable DataTableObject(string selectStatement,
       bool schema, ref ErrorHandler errorHandler)
        {
            try
            {
        ...
        public DataTable GetRecordsDT(string strQuery, ref ErrorHandler errorHandler)
        {
            string selectStatement = strQuery;
            return DataTableObject(selectStatement, false, ref errorHandler);
        }

        public void Initialize(string connectionString, ref ErrorHandler errorHandler)
        {
        ...
        public object ExecuteScalarValue(string commandStatement, ref ErrorHandler errorHandler)
        {
            try
            {
        ...
        public int ExecuteStatement(string commandStatement, ref ErrorHandler errorHandler)
        {
            try
            {
                if (ConnectionOpened(ref errorHandler))
        ...
        public DataTable ExecuteDataReader(string commandStatement, ref ErrorHandler errorHandler)
        {
            try
            {
                if (ConnectionOpened(ref errorHandler))
        ...
        //    return null;
        //}
        private DataSet DataSetObject(string selectStatement, bool schema, ref ErrorHandler errorHandler)
        {
            try
            {
                if (ConnectionOpened(ref errorHandler))
        ...
        private DataSet DataSetObject(bool enforceConstraints, string selectStatement, bool schema, ref ErrorHandler errorHandler)
        {
            try
            {
                if (ConnectionOpened(ref errorHandler))
        ...
        public DataSet GetRecords(string tableName, ref ErrorHandler errorHandler)
        {
            string selectStatement = "SELECT * FROM " + tableName;
            return DataSetObject(selectStatement, false, ref errorHandler);
        }

        public DataSet GetRecords(string columnsName, string tableName, string whereClause, ref ErrorHandler errorHandler)
        {
            string selectStatement = "SELECT " + columnsName + " FROM " + tableName + " WHERE " + whereClause;
            return DataSetObject(selectStatement, false, ref errorHandler);
        }

        public DataSet GetRecords(string columnsName, string tableName, string whereClause, string orderBy, ref ErrorHandler errorHandler)
        {
        ...
        public DataSet GetRecords(bool EnforceConstraints, string columnsName, string tableName, string whereClause, ref ErrorHandler errorHandler)
        {
            string selectStatement = "SELECT " + columnsName + " FROM " + tableName + " WHERE " + whereClause;
        ...
        private bool ConnectionOpened(ref ErrorHandler errorHandler)
        {
            try
            {
        ...
        private void CloseConnection(ref ErrorHandler errorHandler)
        {
            try
            {
                connection.Close();
        ...
        public DataSet GetRecordsDS(string strQuery, ref ErrorHandler errorHandler)
        {
            string selectStatement = strQuery;
            return DataSetObject(selectStatement, ref errorHandler);
        }

        private DataSet DataSetObject(string selectStatement, ref ErrorHandler errorHandler)
        {
            try
            {
                if (ConnectionOpened(ref errorHandler))
        ...
        public bool UpdateRecord(string tableName, string whereClause,
            DataSet dataset, ref ErrorHandler errorHandler)
        {
            string selectStatement = "SELECT * FROM " + tableName
                + " WHERE " + whereClause;

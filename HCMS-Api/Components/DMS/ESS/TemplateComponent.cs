                ...
                var parameters = new Dictionary<string, object>
                        {
                            ...
                            { "@TemplateFileUrl",     templateFileUrl           },
                            { "@TemplateType",        input.TemplateType  },
                            { "@DivisionCode",        CabinetSql.NullIfBlank(input.DivisionCode)             ?? (object)DBNull.Value },
                            { "@DepartmentCode",      CabinetSql.NullIfBlank(input.DepartmentCode)           ?? (object)DBNull.Value },
                            { "@SubDepartmentCode",   CabinetSql.NullIfBlank(input.SubDepartmentCode)        ?? (object)DBNull.Value },
                            { "@BusinessDomainCode",  CabinetSql.NullIfBlank(input.BusinessDomainCode)       ?? (object)DBNull.Value },

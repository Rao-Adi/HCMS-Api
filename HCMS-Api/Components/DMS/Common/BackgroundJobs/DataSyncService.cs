    ...
    private async Task SyncJobProfile(NpgsqlConnection conn, IEnumerable<TblEmpJobProfile> data)
    {
        try
        {
            ...
            foreach (var i in data)
            {
                ...
                await writer.WriteAsync(i.CompanyId, NpgsqlDbType.Integer);
                await writer.WriteAsync(i.AppDoc, NpgsqlDbType.Varchar);
                await writer.WriteAsync(i.DivId, NpgsqlDbType.Integer);
                await writer.WriteAsync(i.DirectRptTo, NpgsqlDbType.Integer);
                ...
                await writer.WriteAsync(i.InDirectRptTo, NpgsqlDbType.Integer);
                ...
                await writer.WriteAsync(i.PrefGender, NpgsqlDbType.Varchar);
                await writer.WriteAsync(i.EYears, NpgsqlDbType.Integer);
                await writer.WriteAsync(i.DsgId, NpgsqlDbType.Integer);
                await writer.WriteAsync(i.RExpYears, NpgsqlDbType.Integer);
                ...
                await writer.WriteAsync(i.PageRangeTo, NpgsqlDbType.Varchar);
                ...
                await writer.WriteAsync(i.VisaStatus, NpgsqlDbType.Varchar);
                ...
                await writer.WriteAsync(i.PrefReligion, NpgsqlDbType.Varchar);
                ...
                await writer.WriteAsync(i.EntDate, NpgsqlDbType.Timestamp);
                await writer.WriteAsync(i.EmoIntlProfiling, NpgsqlDbType.Varchar);
                ...
                await writer.WriteAsync(i.JDChangeVersionNo, NpgsqlDbType.Integer);
    ...
    private async Task SyncEmployees(NpgsqlConnection conn, IEnumerable<tblEmployee> data)
    {
        try
        {
            ...
            foreach (var i in data)
            {
                ...
                await writer.WriteAsync(i.Disabilities, NpgsqlDbType.Boolean);
                ...
                await writer.WriteAsync(i.RelWorking, NpgsqlDbType.Boolean);
                ...
                await writer.WriteAsync(i.DivId, NpgsqlDbType.Integer);
                await writer.WriteAsync(i.UId, NpgsqlDbType.Integer);
                ...
                await writer.WriteAsync(i.AssetStatus, NpgsqlDbType.Varchar);
                await writer.WriteAsync(i.LReason, NpgsqlDbType.Varchar);
                await writer.WriteAsync(i.Shift, NpgsqlDbType.Integer);
                ...
                await writer.WriteAsync(i.ProratedLeave, NpgsqlDbType.Boolean);
                ...
                await writer.WriteAsync(i.PayrollStatus, NpgsqlDbType.Varchar);
                ...
                await writer.WriteAsync(i.HiringChecklistProcess, NpgsqlDbType.Varchar);
                ...
                await writer.WriteAsync(i.Matchedwithblacklist, NpgsqlDbType.Boolean);
                await writer.WriteAsync(i.processmanualmap, NpgsqlDbType.Boolean);
                ...
                await writer.WriteAsync(i.IqamaExpiryHijri, NpgsqlDbType.Varchar);
                ...
                await writer.WriteAsync(i.SpnsTransferable, NpgsqlDbType.Boolean);
                await writer.WriteAsync(i.SpnsType, NpgsqlDbType.Varchar);
                ...
                await writer.WriteAsync(i.IqamaProfession, NpgsqlDbType.Varchar);
                await writer.WriteAsync(i.SpnsExpiryHijri, NpgsqlDbType.Varchar);
                ...
                await writer.WriteAsync(i.ValidDrivingLicenseKSA, NpgsqlDbType.Boolean);
                ...
                await writer.WriteAsync(i.SpnsCategory, NpgsqlDbType.Varchar);
                ...
                await writer.WriteAsync(i.TimeStamp, NpgsqlDbType.Bytea);
                ...
                await writer.WriteAsync(i.FlexiType, NpgsqlDbType.Varchar);
                ...
                await writer.WriteAsync(i.ConveyanceType, NpgsqlDbType.Varchar);
                ...
                await writer.WriteAsync(i.ConveyanceYear, NpgsqlDbType.Integer);

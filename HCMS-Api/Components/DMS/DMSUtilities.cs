...
namespace HCMS_Api.Components.DMS.Common
{
    ...
    public class DMSUtilities
    {
        ...
        public string GetUserRightInRedis(string Key)
        {
            ...
            // is only ever set reactively when a password change is forced. Callers chain
            // .ToString() straight onto this return value with no null check (this file's own
            // CheckSessionTimeOut, plus Utilities.cs' copy of both this method and
            // CheckSessionTimeOut, plus UserPermission.CheckSessionTimeOut), so that null was
